CREATE TYPE "public"."provider" AS ENUM('spotify', 'apple_music', 'tidal', 'deezer', 'youtube_music');--> statement-breakpoint
CREATE TYPE "public"."release_type" AS ENUM('single', 'album', 'ep', 'compilation');--> statement-breakpoint
CREATE TABLE "artist_integrations" (
...
--> statement-breakpoint
ALTER TABLE "artist_integrations" ADD CONSTRAINT "artist_integrations_artist_id_artists_id_fk" FOREIGN KEY ("artist_id") REFERENCES "public"."artists"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "sessions" ADD CONSTRAINT "sessions_artist_id_artists_id_fk" FOREIGN KEY ("artist_id") REFERENCES "public"."artists"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "artist_integrations_artist_provider_unique" ON "artist_integrations" USING btree ("artist_id","provider");